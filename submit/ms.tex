...
Multiple projects that are on--going or planned will generate terabyte to petabyte--sized databases, with their core mission statements to enable an understanding of the Universe through the study of its variability.
...
By reducing the number of objects to measure, these variable sources may be uniquely photometered without significant deblending issues \citep[however, crowded difference images with spatialy overlapping variable sources are possible, e.g.][]{m31}.
